  ...
  const sheets: ExcelSheet[] = [
    ...
    },
    {
      ...
      columns: [
        ...
        // The snapshot, which is what the document said — not a lookup of
        // the branch's name as it reads today.
        ...
        // Always present here, zero and all. A backup is a record of what the
        // rows hold, not a document — the rule about the word never appearing
        // belongs to the invoice a customer reads.
        { header: "Discount %", key: "discount_percent", format: "number", width: 12 },
        { header: "Discount", key: "discount_amount", format: "money", width: 14 },
