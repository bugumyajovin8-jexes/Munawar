      ...
      <CardContent className="pt-5">
        <form action={action} className="flex flex-col gap-4">
          ...
          {/*
            ...
            Signing up is not the moment to be asked for tax registration
            numbers — most people do not have them to hand, and an optional
            field on a first-run form still reads as something you ought to
            fill in. They live in Settings, where they can be added once and
