...
export function ProductDialog({
  ...
  /** Prefills the name typed into the picker that opened this. */
  initialName?: string;
  /**
   * Hands back the row this dialog just wrote, not merely its id — the caller
   * cannot look it up yet, because the mirror hook re-reads asynchronously.
   */
  ...
  function onSubmit(formData: FormData) {
    ...
    startTransition(async () => {
      const saved = productRow(id, fields);
      await applyLocal("products", [saved]);
