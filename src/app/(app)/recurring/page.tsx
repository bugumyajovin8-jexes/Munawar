...
export default async function RecurringPage() {
  ...
  // Bounded by how many schedules a business keeps, so this has never been
  // near the URL limit — but it is the same shape as the three that were, and
  // one implementation is easier to keep right than four.
  const { rows: itemRows } = await selectIn(
